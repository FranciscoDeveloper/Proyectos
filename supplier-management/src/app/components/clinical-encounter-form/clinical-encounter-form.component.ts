...
export class ClinicalEncounterFormComponent implements OnInit {
  ...
  /** Campos mutables, sin ocultos en encuentro, ordenados: obligatorios primero */
  editableFields = computed(() => {
    ...
    const mutable = fields.filter(f => !excluded(f));
    return [...mutable].sort((a, b) => (b.requiredInEncounter ? 1 : 0) - (a.requiredInEncounter ? 1 : 0));
  });
