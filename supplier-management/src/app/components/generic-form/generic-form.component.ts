...
export class GenericFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    } else if (this.schema()?.entity?.disableCreate) {
      // Direct URL access to /new for an entity whose records are only created
      // through another flow (e.g. patients, created when an appointment is booked).
