...
export class GenericFormComponent implements OnInit {
  ...
  editableFields = computed(() => {
    ...
    if (!this.isEncounterMode()) return fields.filter(f => f.type !== 'object-list' && !f.isAutoGenerated && f.type !== 'entity-select');
    return fields.filter(f => !f.isStable && f.type !== 'object-list' && !f.isAutoGenerated && f.type !== 'entity-select');
  });
