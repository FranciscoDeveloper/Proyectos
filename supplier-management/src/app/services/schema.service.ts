...
export class SchemaService {
  ...
  private readonly catalog: Record<string, EntityPayload> = {
    ...
    appointments: {
      ...
      data: [
        { id: 1,  title: 'Control de hipertensión',        patientName: 'María González López',    startDate: '2026-03-03', endDate: '2026-03-03', status: 'completed', room: 'Consultorio 1', notes: 'Ajuste de dosis antihipertensiva.',         createdAt: '2026-02-20', updatedAt: '2026-03-03' },
        { id: 2,  title: 'Revisión post-operatoria',       patientName: 'Carlos Fernández Torres', startDate: '2026-03-05', endDate: '2026-03-05', status: 'completed', room: 'Consultorio 2', notes: 'Evolución favorable tras stent coronario.',  createdAt: '2026-02-22', updatedAt: '2026-03-05' },
        { id: 3,  title: 'Consulta cardiología',           patientName: 'Ana Martínez Soto',       startDate: '2026-03-07', endDate: '2026-03-07', status: 'completed', room: 'Consultorio 1', notes: 'ECG en rango normal.',                       createdAt: '2026-02-25', updatedAt: '2026-03-07' },
        { id: 4,  title: 'Seguimiento diabetes',           patientName: 'Sofia Ruiz Castillo',     startDate: '2026-03-10', endDate: '2026-03-10', status: 'completed', room: 'Consultorio 3', notes: 'Hemoglobina glicosilada 6.8%.',              createdAt: '2026-03-01', updatedAt: '2026-03-10' },
        { id: 5,  title: 'Control respiratorio',           patientName: 'Isabel Díaz Vega',        startDate: '2026-03-12', endDate: '2026-03-12', status: 'completed', room: 'Consultorio 1', notes: 'Espirometría mejorada respecto mes anterior.',createdAt: '2026-03-05', updatedAt: '2026-03-12' },
        { id: 6,  title: 'Revisión fractura fémur',        patientName: 'Roberto García Blanco',   startDate: '2026-03-14', endDate: '2026-03-14', status: 'no_show',   room: 'Consultorio 2', notes: 'Paciente no se presentó. Reprogramar.',     createdAt: '2026-03-05', updatedAt: '2026-03-14' },
        { id: 7,  title: 'Primera consulta',               patientName: 'Pedro Alvarado Cruz',     startDate: '2026-03-17', endDate: '2026-03-17', status: 'completed', room: 'Consultorio 1', notes: 'Derivado por médico de cabecera.',            createdAt: '2026-03-10', updatedAt: '2026-03-17' },
        { id: 8,  title: 'Control cardiológico',           patientName: 'Lucía Vega Moreno',       startDate: '2026-03-19', endDate: '2026-03-19', status: 'cancelled', room: 'Consultorio 3', notes: 'Cancelada por paciente.',                    createdAt: '2026-03-12', updatedAt: '2026-03-19' },
        { id: 9,  title: 'Ajuste de tratamiento',          patientName: 'Carlos Fernández Torres', startDate: '2026-03-21', endDate: '2026-03-21', status: 'completed', room: 'Consultorio 2', notes: 'Reducción de anticoagulante.',                createdAt: '2026-03-15', updatedAt: '2026-03-21' },
        { id: 10, title: 'Control mensual',                patientName: 'María González López',    startDate: '2026-03-24', endDate: '2026-03-24', status: 'completed', room: 'Consultorio 1', notes: 'Presión arterial estabilizada.',              createdAt: '2026-03-17', updatedAt: '2026-03-24' },
        { id: 11, title: 'Revisión exámenes',              patientName: 'Miguel Torres Fuentes',   startDate: '2026-03-26', endDate: '2026-03-26', status: 'scheduled', room: 'Consultorio 2', notes: 'Evaluar resultados de laboratorio.',          createdAt: '2026-03-20', updatedAt: '2026-03-20' },
        { id: 12, title: 'Seguimiento postquirúrgico',     patientName: 'Luis Hernández Pérez',    startDate: '2026-03-27', endDate: '2026-03-27', status: 'scheduled', room: 'Consultorio 1', notes: 'Cita de seguimiento a 4 meses.',              createdAt: '2026-03-20', updatedAt: '2026-03-20' },
        { id: 13, title: 'Control diabetes',               patientName: 'Sofia Ruiz Castillo',     startDate: '2026-03-28', endDate: '2026-03-28', status: 'scheduled', room: 'Consultorio 3', notes: 'Control mensual.',                           createdAt: '2026-03-21', updatedAt: '2026-03-21' },
        { id: 14, title: 'Consulta de urgencia',           patientName: 'Carmen López Ibáñez',     startDate: '2026-03-31', endDate: '2026-03-31', status: 'scheduled', room: 'Consultorio 2', notes: 'Derivación urgente por dolor torácico.',      createdAt: '2026-03-25', updatedAt: '2026-03-25' },
        { id: 15, title: 'Revisión eco-cardiograma',       patientName: 'Ana Martínez Soto',       startDate: '2026-04-03', endDate: '2026-04-03', status: 'scheduled', room: 'Consultorio 1', notes: 'Seguimiento post cirugía.',                  createdAt: '2026-03-20', updatedAt: '2026-03-20' },
        { id: 16, title: 'Control respiratorio trimestral',patientName: 'Isabel Díaz Vega',        startDate: '2026-04-07', endDate: '2026-04-07', status: 'scheduled', room: 'Consultorio 1', notes: 'Revisión trimestral EPOC.',                  createdAt: '2026-03-22', updatedAt: '2026-03-22' }
      ]
    },
