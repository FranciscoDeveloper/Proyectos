...
export const SCHEMA_CLINICAL_RECORDS: EntitySchema = {
  ...
  fields: [
    ...
    { name: 'habits',           type: 'textarea', label: 'Hábitos',                 required: false, showInList: false, showInDetail: true, section: 'history' },

    // ── Intervenciones quirúrgicas ────────────────────────────────────────
    { name: 'surgicalHistory',      type: 'textarea', label: 'Antecedentes Quirúrgicos',   required: false, showInList: false, showInDetail: true, section: 'surgical' },
    { name: 'plannedInterventions', type: 'textarea', label: 'Intervenciones Programadas', required: false, showInList: false, showInDetail: true, section: 'surgical' },

    // ── Medicación ────────────────────────────────────────────────────────
    { name: 'currentMedications', type: 'textarea', label: 'Medicación Actual',  required: false, showInList: false, showInDetail: true, section: 'medications', isPrescription: true },
...
// ─────────────────────────── DENTAL TREATMENTS (clinical-record) ─────────────
const SCHEMA_DENTAL_TREATMENTS: EntitySchema = {
  entity: {
    key: 'dental-treatments',
    singular: 'Plan de Tratamiento',
    plural: 'Planes de Tratamiento',
    icon: 'clipboard',
    moduleType: 'clinical-record',
    description: 'Gestión de planes de tratamiento odontológico con versionado y auditoría'
  },
  fields: [
    // ── Identificación del plan ───────────────────────────────────────────
    { name: 'fullName',    type: 'text', label: 'Paciente',    required: true,  isTitle: true,    showInList: true,  showInDetail: true, section: 'demographics', filterable: true, filterType: 'search', sortable: true, isStable: true },
    { name: 'patientId',   type: 'text', label: 'Nº Plan',     required: false, isSubtitle: true, showInList: true,  showInDetail: true, section: 'demographics', pattern: '^TRT-\\d{5}$', patternMessage: 'Formato: TRT-00000', isStable: true, isAutoGenerated: true },
    { name: 'rut',         type: 'text', label: 'RUT',         required: true,                   showInList: false, showInDetail: true, section: 'demographics', isStable: true },
    { name: 'birthDate',   type: 'date', label: 'Fecha Nac.',  required: false,                   showInList: false, showInDetail: true, section: 'demographics', format: 'date', isStable: true },
    { name: 'age',         type: 'number', label: 'Edad',      required: false,                   showInList: false, showInDetail: true, section: 'demographics', min: 0, max: 150, isStable: true },
    { name: 'gender',      type: 'select', label: 'Sexo',      required: false,                   showInList: false, showInDetail: true, section: 'demographics', isStable: true,
      options: [{ value: 'male', label: 'Masculino' }, { value: 'female', label: 'Femenino' }, { value: 'other', label: 'Otro' }]
    },
    { name: 'insurance',   type: 'select', label: 'Previsión', required: false, isBadge: true,    showInList: false, showInDetail: true, section: 'demographics', isStable: true,
      options: [
        { value: 'fonasa_a', label: 'FONASA A' }, { value: 'fonasa_b', label: 'FONASA B' },
        { value: 'fonasa_c', label: 'FONASA C' }, { value: 'fonasa_d', label: 'FONASA D' },
        { value: 'isapre',   label: 'ISAPRE'   }, { value: 'particular', label: 'Particular' }
    ...
    { name: 'phone',       type: 'tel',  label: 'Teléfono',   required: false,                   showInList: false, showInDetail: true, section: 'demographics', isStable: true },
    { name: 'email',       type: 'email', label: 'Email',     required: false,                   showInList: false, showInDetail: true, section: 'demographics', isStable: true },
    { name: 'doctor',      type: 'text', label: 'Odontólogo/a', required: true,                  showInList: true,  showInDetail: true, section: 'demographics', filterable: true, filterType: 'search', isStable: true },
    { name: 'lastVisit',   type: 'date', label: 'Última Atención', required: false,               showInList: true,  showInDetail: true, section: 'demographics', sortable: true, format: 'date' },
    { name: 'status',      type: 'select', label: 'Estado del Plan', required: true, isBadge: true, showInList: true, showInDetail: true, section: 'demographics', filterable: true, filterType: 'select',
      options: [
      ...
      badgeColors: { draft: '#6b7280', approved: '#3b82f6', in_progress: '#f59e0b', completed: '#10b981', cancelled: '#ef4444' }
    },
    ...
    // ── Resumen del plan (vitales repropuestos) ───────────────────────────
    { name: 'bp',              type: 'text', label: 'Dolor Inicial (EVA 0-10)', required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: '0-10' },
    { name: 'heartRate',       type: 'text', label: 'Piezas Dentales',          required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'FDI: 11,12,21,22…' },
    { name: 'temperature',     type: 'text', label: 'Presupuesto Total (CLP)',  required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'Ej. $1.500.000' },
    { name: 'o2Saturation',    type: 'text', label: 'Monto Cancelado (CLP)',    required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'Ej. $750.000' },
    { name: 'weight',          type: 'text', label: 'Sesiones Estimadas',       required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'Nº sesiones' },
    { name: 'height',          type: 'text', label: 'Versión del Plan',         required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'v1, v2…', isStable: true },
    { name: 'bmi',             type: 'text', label: 'Fecha Inicio',             required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'DD/MM/YYYY' },
    { name: 'respiratoryRate', type: 'text', label: 'Fecha Fin Estimada',       required: false, isVitalSign: true, showInList: false, showInDetail: true, section: 'vitals', placeholder: 'DD/MM/YYYY' },

    // ── Antecedentes ──────────────────────────────────────────────────────
    { name: 'personalHistory', type: 'textarea', label: 'Antecedentes Médicos Relevantes', required: false, showInList: false, showInDetail: true, section: 'history', isStable: true },
    { name: 'familyHistory',   type: 'textarea', label: 'Antecedentes Familiares',         required: false, showInList: false, showInDetail: true, section: 'history', isStable: true },
    { name: 'habits',          type: 'textarea', label: 'Hábitos',                         required: false, showInList: false, showInDetail: true, section: 'history', isStable: true },

    // ── Plan por pieza dental ─────────────────────────────────────────────
    { name: 'surgicalHistory',      type: 'textarea', label: 'Tratamientos Previos',             required: false, showInList: false, showInDetail: true, section: 'surgical', isSurgical: true, isStable: true },
    { name: 'plannedInterventions', type: 'textarea', label: 'Plan Detallado por Pieza Dental',  required: false, showInList: false, showInDetail: true, section: 'surgical', isSurgical: true,
      placeholder: 'Pieza 11: Endodoncia + Corona\nPieza 12: Obturación clase II\nPieza 21: Implante…' },

    // ── Medicación ────────────────────────────────────────────────────────
    { name: 'currentMedications', type: 'textarea', label: 'Medicación Relacionada', required: false, showInList: false, showInDetail: true, section: 'medications', isPrescription: true },
    { name: 'chronicConditions',  type: 'tags',     label: 'Condiciones Crónicas',   required: false, showInList: false, showInDetail: true, section: 'medications', isStable: true },

    // ── Diagnóstico y presupuesto ─────────────────────────────────────────
    { name: 'diagnosisCode',  type: 'text',     label: 'Código CIE / ICDAS',        required: false, showInList: false, showInDetail: true, section: 'diagnosis', isStable: true },
    { name: 'diagnosisLabel', type: 'text',     label: 'Diagnóstico Principal',      required: false, showInList: false, showInDetail: true, section: 'diagnosis', isStable: true },
    { name: 'differentialDx', type: 'textarea', label: 'Desglose del Presupuesto',   required: false, showInList: false, showInDetail: true, section: 'diagnosis', isStable: true,
      placeholder: 'Endodoncia pieza 11: $250.000\nCorona metal-cerámica p.11: $350.000\nImplante p.21: $900.000\n— TOTAL: $1.500.000' },
    ...
    { name: 'soapObjective',  type: 'textarea', label: 'Examen Clínico (O)',            required: false, showInList: false, showInDetail: true, section: 'soap', placeholder: 'Hallazgos clínicos, radiográficos, fotografías' },
    { name: 'soapAssessment', type: 'textarea', label: 'Plan de Tratamiento Aprobado (A)', required: false, showInList: false, showInDetail: true, section: 'soap', placeholder: 'Descripción completa del plan aprobado por el paciente' },
    { name: 'soapPlan',       type: 'textarea', label: 'Procedimientos Realizados / Próximos Pasos (P)', required: false, showInList: false, showInDetail: true, section: 'soap', placeholder: 'Procedimientos completados, fecha y sesión. Próxima cita.' },

    // ── Historial de versiones (auditoría) ────────────────────────────────
    { name: 'encounters', type: 'object-list', label: 'Historial de Versiones del Plan', required: false, showInList: false, showInDetail: true, section: 'encounters' }
  ]
};
...
export const MOCK_USERS: MockUser[] = [
  ...
  },
  {
    ...
    schemas: [SCHEMA_DENTAL_SESSIONS, SCHEMA_DENTAL_RECORDS, SCHEMA_DENTAL_TREATMENTS]
  }
];
