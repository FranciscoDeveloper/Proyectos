...
export const SCHEMA_CLINICAL_RECORDS: EntitySchema = {
  ...
  fields: [
    ...
    { name: 'patientId',      type: 'text',     label: 'ID Paciente',         required: false, isSubtitle: true,  showInList: true,  showInDetail: true,  section: 'demographics', pattern: '^PAC-\\d{5}$', patternMessage: 'Formato: PAC-00000', isStable: true, isAutoGenerated: true },
    ...
    { name: 'bloodType',      type: 'select',   label: 'Grupo Sanguíneo',     required: true,  isBadge: true,     showInList: true,  showInDetail: true,  section: 'demographics', isStable: true, lockWhenHasEncounters: true,
