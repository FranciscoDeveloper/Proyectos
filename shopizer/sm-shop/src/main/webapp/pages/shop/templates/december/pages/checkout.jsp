				...
				<div class="row">
					<div class="col-md-12">
						<div class="entry-header">
							<h1 class="entry-title"><s:message code="${requestScope.token}" text="${requestScope.token}" /></h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="coupon-accordion">
							...
							<sec:authorize access="!hasRole('AUTH_CUSTOMER') and !fullyAuthenticated">
								<p class="muted common-row"><a href="<c:url value="/shop/customer/customLogon.html"/>"><s:message code="${requestScope.token}" text="${requestScope.token}" /></a></p>
							</sec:authorize>					
						</div>
					</div>
				</div>
