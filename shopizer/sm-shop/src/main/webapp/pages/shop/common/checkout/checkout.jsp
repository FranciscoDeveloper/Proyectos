...
<c:set var="creditCardInformationsPage" value="creditCardInformations"
	scope="request" />
...
<div id="main-content" class="container row-fluid">
	<h1 class="checkout-title">
		<s:message code=" el token es  ${WebPayToken}"  text="el token es ${WebPayToken}" " />
	</h1>
	<sec:authorize
					...
					<div class="span8 col-md-8 no-padding-left">
						...
						<div id="shippingBox" class="checkout-box">
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="customer.firstName"
												cssClass="input-large required form-control form-control-lg"
												path="customer.billing.firstName" autofocus="autofocus"
												title="${msgFirstName}" />
											<form:errors path="customer.billing.firstName"
												cssClass="error" />
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="customer.lastName"
												...
												title="${msgLastName}" />
											<form:errors path="customer.billing.lastName"
												cssClass="error" />
							...
							<div class="row-fluid common-row row">
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="customer.emailAddress"
												cssClass="input-large required email form-control form-control-lg"
								...
								<div class="span4 col-md-4">
									<div class="control-group form-group">
										<label><s:message
												code="label.customer.billing.company" text="Billing company" /></label>
										<div class="controls">
											<form:input id="customer.billing.company"
												cssClass="input-large form-control form-control-lg"
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="customer.billing.address"
												cssClass="input-xxlarge required form-control form-control-lg"
							...
							<div class="row-fluid common-row row">
								<div class="span4 col-md-4">
									<div class="control-group form-group">
										<label><s:message code="label.generic.city"
												text="City" /></label>
										<div class="controls">
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="billingPostalCode"
												cssClass="input-large required billing-postalCode form-control form-control-lg"
							...
							<div class="row-fluid common-row row">
								<div class="span8 col-md-8">
									<div class="control-group form-group">
										...
										<div class="controls">
											<form:select
												cssClass="zone-list form-control form-control-lg"
											...
											<form:input
												class="input-large required form-control form-control-lg"
							...
							<div class="row-fluid common-row row">
								<div class="span4 col-md-4">
									<div class="control-group form-group">
										...
										<div class="controls">
											<form:select
												cssClass="billing-country-list form-control form-control-lg"
									...
									<div class="control-group form-group">
										...
										<div class="controls">
											...
											<form:input id="customer.billing.phone"
												cssClass="input-large required billing-phone form-control form-control-lg"
							...
							<c:if test="${shippingQuote!=null}">
								...
								<div class="row-fluid common-row row">
									<div class="span8 col-md-8">
										<label id="useAddress" class="checkbox"> <form:checkbox
												path="shipToBillingAdress" id="shipToBillingAdress" /> <s:message
												code="label.customer.shipping.shipaddress"
						...
						<c:if test="${shippingQuote!=null}">
							...
							<div id="deliveryBox" class="checkout-box">
								<span class="box-title">
									<p class="p-title">
										<s:message code="label.customer.shippinginformation"
								...
								<div class="row-fluid common-row row">
									<div class="span4 col-md-4">
										<div class="control-group form-group">
											...
											<div class="controls">
												<form:input id="customer.delivery.company"
													cssClass="input-large form-control form-control-lg"
									...
									<div class="span8 col-md-8">
										<div class="control-group form-group">
											<label><s:message
													...
													text="Shipping street address" /></label>
											<div class="controls">
									...
									<div class="span4 col-md-4">
										<div class="control-group form-group">
											<label><s:message
													...
													text="Shipping postal code" /></label>
											<div class="controls">
												...
												<form:input id="deliveryPostalCode"
													cssClass="input-large required delivery-postalCode form-control form-control-lg"
									...
									<div class="span8 col-md-8">
										<div class="control-group form-group">
											<label><s:message code="label.customer.shipping.zone"
													text="Shipping state / province" /></label>
											<div class="controls">
												<form:select cssClass="zone-list form-control"
													id="deliveryStateList" path="customer.delivery.zone" />
									...
									<div class="span8 col-md-8">
										<div class="control-group form-group">
											<label><s:message
													...
													text="Shipping country" /></label>
											<div class="controls">
												<form:select cssClass="shipping-country-list form-control"
							...
							<div class="checkout-box">
								...
								<c:choose>
									<c:when test="${fn:length(shippingQuote.shippingOptions)>0}">
										<input type="hidden" id="shippingModule" name="shippingModule"
											value="${shippingQuote.shippingModuleCode}">
										<div id="shippingSection" class="control-group">
											<label class="control-label"> <s:message
													code="label.shipping.options" text="Shipping options" /> <c:if
													test="${shippingQuote.handlingFees!=null && shippingQuote.handlingFees>0}">
								       					&nbsp;(<s:message code="label.shipping.handlingfees"
														text="Handling fees" />&nbsp;<sm:monetary
														value="${shippingQuote.handlingFees}" />)
								       				</c:if>
											</label>
											<div id="shippingOptions" class="controls">
												<c:if
													...
													<strong> <s:message
															...
															text="A shipping quote will be available after filling the postal code" />
													</strong>
												</c:if>
												<c:forEach items="${shippingQuote.shippingOptions}"
													var="option" varStatus="status">
													<label class="radio"> <input type="radio"
														name="selectedShippingOption.optionId"
														class="shippingOption" code="${option.shippingModuleCode}"
														...
														<s:message
															...
															text="${option.shippingModuleCode}" /> -
														${option.optionPriceText} <c:if
															test="${option.note!=null}">
															<br />
															<small><c:out value="${option.note}" /></small>
														</c:if>
													</label>
												</c:forEach>
											</div>
						...
						<!-- Shipping -->
						<div class="checkout-box" id="confirmShippingAddress"
						...
						<c:if test="${fn:length(paymentMethods)>0}">
							...
							<div class="checkout-box">
								<span class="box-title">
									<p class="p-title">
										<s:message code="label.payment.module.title"
											text="Payment method" />
									</p>
								</span>
									...
									<ul class="nav nav-tabs nav-tabs-checkout">
										<c:forEach items="${paymentMethods}" var="paymentMethod">
											<li
												...
												class="paymentTab"
												onClick="setPaymentModule('${paymentMethod.paymentMethodCode}');">
													<c:choose>
														<c:when
															test="${paymentMethod.paymentType=='CREDITCARD' || paymentMethod.paymentType=='PAYPAL'}">
															<c:if test="${paymentMethod.paymentType=='CREDITCARD'}">
																<p id="cc-img-container">
																	<img
																		src="<c:url value="/resources/img/payment/icons/visa-straight-64px.png"/>"
																		width="40" style="display: inline-block;"> <img
																		src="<c:url value="/resources/img/payment/icons/mastercard-straight-64px.png"/>"
																		width="40" style="display: inline-block;"> <img
																		src="<c:url value="/resources/img/payment/icons/american-express-straight-64px.png"/>"
																		width="40" style="display: inline-block;">
																</p>
															</c:if>
															<c:if test="${paymentMethod.paymentType=='PAYPAL'}">
																<img
																	src="<c:url value="/resources/img/payment/icons/paypal-straight-64px.png"/>"
																	width="40">
															</c:if>
														</c:when>
														<c:otherwise>
					...
					<div class="span4 col-md-4 no-padding">
						...
						<div class="checkout-box">
							...
							<table id="summary-table"
								...
								<thead>
									<tr>
										<th width="45%"><s:message code="label.order.item"
												text="Item" /></th>
										<!--<th width="15%"><s:message code="label.quantity" text="Quantity" /></th>-->
										<th width="20%"><s:message code="label.order.price"
												text="Price" /></th>
										<th width="20%"><s:message code="label.order.total"
												text="Total" /></th>
									</tr>
								</thead>
								...
								<tbody id="summaryRows">
									<c:forEach items="${cart.shoppingCartItems}"
										...
										<tr class="item">
											<td width="38%">${shoppingCartItem.quantity}x
												${shoppingCartItem.name} <c:if
							...
							<div id="totalRow" class="total-box">
								<span class="total-box-grand-total"> <font
									class="total-box-label"> <s:message
											code="order.total.total" text="Total" /> <font
										class="total-box-price grand-total"><sm:monetary
						...
						<c:if
							...
							<div class="checkout-box" id="customerAgreementSection" class="">
								<label id="customerAgreement" class="checkbox"> <s:message
										...
										title="${msgAgreement}" /> <a href="javascript:return false;"
									id="clickAgreement"><s:message
