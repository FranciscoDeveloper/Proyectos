...
//<![CDATA[ 
	...
	<div id="main-content" class="container clearfix no-padding-left">
		<h1><s:message code="label.checkout.confirmation" text="Order completed 2" /></h1>
		<div class="row-fluid">
			<div class="span12">  
            ...
            <c:if test="${requestScope.CONTENT['confirmation']!=null}">
	            <div class="span12">
	            	<sm:pageContent contentCode="confirmation"/>
             					...
             					<c:set var="commitUrl" value="${pageContext.request.contextPath}/shop/order/webpay.html"/>
